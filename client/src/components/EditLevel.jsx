...
export default function EditLevel ({level, levels, setLevels, setSteps}) {
  ...
  return (
    <div className='EditLevelModal'>
      ...
      <button type="button" className="button_edit" data-toggle="modal" data-target={`#editlevelmodal-${level.levelid}`}>
        Edit
      </button>

      {/* The Modal */}
      <div className="modal" id={`editlevelmodal-${level.levelid}`}>
